...
import { OrderProductItemsList } from '@/components/OrderProductItemsList';
...
export default async function SellerOrdersPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 space-y-6">
      <OrdersViewContainer
        title="Gestión de Pedidos de Caserío"
        subtitle="Valida las compras de tus clientes y confirma la fecha de entrega"
                  ...
                  {pendingOrders.map((order) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* 3. Los productos y total de productos con OrderProductItemsList */}
                        <div className="space-y-2.5 bg-white p-3.5 rounded-2xl border border-amber-200 shadow-inner">
