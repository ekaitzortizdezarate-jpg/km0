            ...
            {pendingOrders.map((order) => {
              ...
              return (
                ...
                >
                  ...
                  {/* 3. Los productos: justo debajo de la imagen, entre el nombre y el precio los 3 iconos de entrega */}
                          ...
                          <div className="flex items-center gap-2.5 min-w-0 flex-1">
                            ...
                            <div className="shrink-0">
                              {item.products?.image_url ? (
                                ...
                                <div className="w-12 h-12 rounded-lg bg-emerald-50 text-emerald-800 font-black text-[10px] flex items-center justify-center border border-emerald-200 shrink-0">
                                  km0
                                </div>
                              )}
                            </div>
