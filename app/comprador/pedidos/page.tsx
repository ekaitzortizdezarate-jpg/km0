...
export default async function BuyerOrdersPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 space-y-6">
      <OrdersViewContainer
        title="Mis Compras"
        subtitle="Historial de pedidos, validaciones de caseríos y fechas confirmadas de entrega"
              ...
              orders.map((order) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* 3. Lista de productos con modo de vista dinámico y badges de entrega */}
